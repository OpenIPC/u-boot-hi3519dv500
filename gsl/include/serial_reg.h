 ...
 *
 */
#define UART_PL01_DR                   0x00	 /*  Data read or written from the interface. */
#define UART_PL01_RSR                  0x04	 /*  Receive status register (Read). */
#define UART_PL01_ECR                  0x04	 /*  Error clear register (Write). */
#define UART_PL01_FR                   0x18	 /*  Flag register (Read only). */

#define UART_PL01_RSR_OE               0x08
#define UART_PL01_RSR_BE               0x04
#define UART_PL01_RSR_PE               0x02
#define UART_PL01_RSR_FE               0x01

#define UART_PL01_FR_TXFE              0x80
#define UART_PL01_FR_RXFF              0x40
#define UART_PL01_FR_TXFF              0x20
#define UART_PL01_FR_RXFE              0x10
#define UART_PL01_FR_BUSY              0x08
#define UART_PL01_FR_TMSK              (UART_PL01_FR_TXFF + UART_PL01_FR_BUSY)
