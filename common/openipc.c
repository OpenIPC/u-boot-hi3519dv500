...
/* DV500's aarch64 gzip FIT is larger than cv6xx's, so the squashfs sits well
 * past 4 MiB — scan the whole 16 MiB NOR (bounded by flash->size below). */
#define SCAN_LIMIT 0x1000000
