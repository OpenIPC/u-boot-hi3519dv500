...
{
    return drv_cipher_symc_encrypt_multi(symc_handle, symc_ctrl, src_buf_pack, dst_buf_pack, pack_num);
}

td_s32 ot_mpi_cipher_symc_decrypt_multi(td_handle symc_handle, const crypto_symc_ctrl_t *symc_ctrl,
    const crypto_symc_pack *src_buf_pack, const crypto_symc_pack *dst_buf_pack, td_u32 pack_num)
{
    return drv_cipher_symc_decrypt_multi(symc_handle, symc_ctrl, src_buf_pack, dst_buf_pack, pack_num);
}