...
write_op:
	...
	if (rc) {
		printf("write file %s operation failed\n", aufile[idx]);
		return rc;
	}
...
static int env_verify(char *env)
{
...
static struct blk_desc *detect_external_storage(int dev_index)
{
