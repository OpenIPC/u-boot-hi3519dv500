...
int usb3_driver_init(void)
{
	...
	(void)memcpy_s(usb3_dev->string_manu, STRING_MANU_LENGTH, string_manu, usb3_dev->string_manu_len);
	(void)memcpy_s(usb3_dev->string_prod, STRING_PROD_LENGTH, string_prod, usb3_dev->string_prod_len);
	usb3_dev->pcd.ep0_setup_desc =
		(usb3_dma_desc_t *)((phys_addr_t)(usb3_dev->pcd.ep0_setup + 0xf) &
		(unsigned int)(~0xf));
